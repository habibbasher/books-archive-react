          ...
          <Grid columns={2} fluid stakeable>
            ...
            <Grid.Row>
              ...
              <Grid.Column>
                ...
                <Form.Field error={!!errors.title}>
                  ...
                  <input type="text" id="title" name="title"
                    placeholder="Title" value={data.title} onChange={this.onChange} />
                ...
                <Form.Field error={!!errors.authors}>
                  ...
                  <input type="text" id="authors" name="authors"
                    placeholder="Authors" value={data.authors} onChange={this.onChange} />
                ...
                <Form.Field error={!!errors.pages}>
                  ...
                  <input type="number" id="pages" name="pages"
                    value={data.pages} onChange={this.onChangeNumber} />
              ...
              <Grid.Column>
                ...
                { covers.length > 1 && <a role="button" tabIndex={0}
